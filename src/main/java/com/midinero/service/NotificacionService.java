...
public class NotificacionService {
    ...
    public void enviarNotificacionPresupuestoExcedido(
            Long usuarioId, String categoria, Double gastoActual, Double limite) {
        ...
        notificacion.put("mensaje", String.format(
                "Has excedido el presupuesto de %s. Gasto actual: $%.2f, Límite: $%.2f",
        ...
        // El destino por-usuario estándar en Spring es /user/queue/...
    ...
    public void enviarNotificacionMetaCompletada(Long usuarioId, String nombreMeta) {
        ...
        notificacion.put("mensaje", String.format(
                "¡Felicidades! Has completado tu meta de ahorro: %s", nombreMeta));
